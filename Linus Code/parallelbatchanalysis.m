...
parfor i = 1:length(num)
    ...
    [ foundbarcodes, points, copynumfinal, rawfound, hybnum, copynumfinalsum, totdropped ] = BarcodeNoMiji_v5( channels, hybnum, hyb, multiplier, HCRorFISH, barcodekey, PathName, num(i), 'roi', mask, [],[],6,1,1,0, 0 );
