...
parfor i = 1:length(num)
    ...
    [ foundbarcodes, points, copynumfinal, rawfound, copynumfinalsum, totdropped ] = BarcodeNoPoints_v5( channels, hyb, barcodekeyall, PathName, num(i), segmentation, regvec{i},6,1,1,1, 0 );
